...
def capture_all_stats():
    ...
    cv2.imwrite(save_dir, border_bar)
    full_img = cv2.imread(save_dir)

    print("capturing base stats...")
    ...
    print("capturing resource stats...")
